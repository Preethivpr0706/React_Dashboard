       ...
       <main className="p-4">  
        ...
        <div className="row">  
          <div className="col-md-3 mb-4">  
           <div className="widget card p-4 rounded shadow-sm" onClick={() => handleViewAppointmentDetails('Confirmed')}>  
          ...
          <div className="col-md-3 mb-4">  
           <div className="widget card p-4 rounded shadow-sm" onClick={handleViewDepartments}>  
          ...
          <div className="col-md-3 mb-4">  
           <div className="widget card p-4 rounded shadow-sm" onClick={handleDoctorsList}>  
            <h4>Total Doctors</h4>  
          ...
          <div className="col-md-3 mb-4">  
           <div className="widget card p-4 rounded shadow-sm" onClick={() => handleViewAppointmentDetails('Cancelled')}>  
